...
consider asymmetric travel times to reflect for real-world traffic and road networks. We also consider time-based objective functions 
...
Allows configuring the number of customers, carriers, vehicle capacities, customer exclusivity rates, and time/distance matrices.
